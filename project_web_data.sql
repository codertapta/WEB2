...
INSERT INTO `import_orders` (`id`, `import_date`, `importer`, `status`, `created_at`) VALUES
(1, '2025-10-20', 'Nguyễn Văn A', 0, '2025-10-20 08:00:00'),
(2, '2025-10-18', 'Trần Tấn Phát', 1, '2025-10-18 09:30:00');
...
INSERT INTO `import_details` (`id`, `import_order_id`, `product_id`, `cost_price`, `quantity`) VALUES
(1, 1, 1, 42000000, 5),
(2, 1, 2, 30000000, 2),
(3, 2, 3, 25000000, 3),
(4, 2, 4, 28000000, 2),
...
ALTER TABLE `import_details`
  ADD CONSTRAINT `fk_import_details_order`   FOREIGN KEY (`import_order_id`) REFERENCES `import_orders` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_import_details_product` FOREIGN KEY (`product_id`)      REFERENCES `products`       (`id`) ON DELETE CASCADE;
